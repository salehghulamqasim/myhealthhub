...
<!DOCTYPE html>
    ...
    <div class="container-first">
        <div class= "container-second">
            ...
            <a href="http://localhost/project/displays/profile_files.php" style="text-decoration: none;">
                ...
                <div class="form-word">form </div>
                    ...
                    <a href="file1.php"><button class="btn selected" type="button">file 1</button></a>

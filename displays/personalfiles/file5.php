...
<!DOCTYPE html>
    ...
    <style>
        ...
        .arrowback:active {
        transform: scale(0.80) translateY(0.50px) scaleX(+1); /* Flip horizontally */
    ...
    <div class="container-first">
        <div class= "container-second">
            ...
            <a href="file4.php" style="text-decoration: none;">
                ...
                <div class="form-word">form </div>
                    ...
                    <a href="file2.php"><button class="btn" type="button">file 2</button></a>
                    ...
                    <a href="file5.php"><button class="btn selected" type="button">file 5</button></a>
                    </div>
    ...
    <!-- Add below line only when u have a next file6.php 
        <script>

...
<!DOCTYPE html>
    ...
    <style>
        ...
        #date{
                ...
                border-radius: 47px;
                padding:2px 11px;
                box-shadow: 0px 1px 5px rgba(216, 210, 252, 0.90);
    ...
    <div class="container-first">
        ...
        <a href="javascript:history.go(-1)" style="text-decoration: none;">
            <img src="/project/img/vector.svg" alt="Arrow" class="arrow" width="30px" >
                ...
                <h4 style="margin-right: 850px;" class="files">Devices</h4>
               ...
               <div class="add-more-bar">
                ...
                <p style="padding-left: 11px;">Expiry date</p>
                ...
                <div style="margin:-5px 40px;"class="hey">
                    <p>Device name
                    <input style="margin-left: 505px; font-size: 13px; width:120px;" type="date" id="date" name="date" value="2022-11-25">
                    ...
                    <p>Device name
                    <input style="margin-left: 507px; font-size: 13px; width:120px;" type="date" id="date" name="date" value="2022-11-25">
                         <input type="checkbox" name="unverified" class="checkbox">
                   </p>
                    <div class="grey-line"></div>
